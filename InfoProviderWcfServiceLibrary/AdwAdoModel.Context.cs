...
namespace InfoProviderWcfServiceLibrary
{
    ...
    public partial class AdventureWorksLTEntities : DbContext
    {
        ...
        public virtual DbSet<ProductDescriptionEntity> ProductDescriptionEntities { get; set; }
        ...
        [DbFunction("AdventureWorksLTEntities", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[AdventureWorksLTEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("AdventureWorksLTEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[AdventureWorksLTEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
